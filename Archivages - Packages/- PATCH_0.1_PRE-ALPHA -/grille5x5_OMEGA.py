# Cree par Sinan et Fabien le 21/03/2016 en Python 3.2
...
"""MATRICE_CENTRAL = ones((LIGNES, COLONNES))
MATRICE_GAUCHE = zeros((5, 3))
...
# Affichage des différentes grilles
    ...
    Afficher_Indic_Gauche(FENETRE, BLUE_PEGASUS, X_ORIGINE, Y_ORIGINE, 3, 5, MATRICE_GAUCHE)

    Afficher_Indic_Haut(FENETRE, BLUE_PEGASUS, X_ORIGINE,Y_ORIGINE, 3, 5, MATRICE_HAUT)

    if allclose(MATRICE_CENTRAL, MATRICE_GRILLE):
            continuer = 0
