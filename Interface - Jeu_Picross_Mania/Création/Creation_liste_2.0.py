...
#-------------------------------------------------------------------------------
            ...
            # Cette boucle parcourt la grille centrale en longueur.
            for CASE_X in range (NBR_CARRE_CENTRAL):
                GRILLE_GAUCHE = [] # défini la grille de gauche comme une liste, celle ci initalisée comme vide
                PRECEDENT = 0 #intialise la variable PRECEDENT à 0 soit comme une case vide

                # Cette boucle parcourt la grille centrale en hauteur.
                for CASE_Y in range(NBR_CARRE_CENTRAL):
                    ...
                    PRECEDENT= CASE_X #à chaque fois que la boucle se termine, on redéfini precedent comme la case_x qui va être réutilisé pour la boucle suivante
            ...
            for CASE_Y in range (NBR_CARRE_CENTRAL):
                ...
                for CASE_X in range(NBR_CARRE_CENTRAL):
                    ...
                    PRECEDENT= CASE_Y #à chaque fois que la boucle se termine, on redéfini precedent comme la case_x qui va être réutilisé pour la boucle suivante

                if GRILLE_HAUT == []: #si à la fin de la boucle, la liste est vide
