...
def Afficher_Carre(SUPPORT, COULEUR, X_ORIGINE, Y_ORIGINE, CASE_X, CASE_Y, TAILLE_CARRE):
...
def Afficher_Indic_Gauche(SUPPORT, COULEUR, X_ORIGINE, Y_ORIGINE, NBR_CARRE_PETIT, NBR_CARRE_GRAND, TAILLE_POLICE, TAILLE_CARRE, MATRICE_GAUCHE):
    font = pygame.font.Font(None, TAILLE_POLICE)
    for X in range(NBR_CARRE_PETIT):
        for Y in range(NBR_CARRE_GRAND):
            X_START = ((X_ORIGINE - NBR_CARRE_PETIT * TAILLE_CARRE + 3) + X * TAILLE_CARRE + 3 + TAILLE_CARRE//4)
...
def Afficher_Indic_Haut(SUPPORT, COULEUR, X_ORIGINE, Y_ORIGINE, NBR_CARRE_PETIT, NBR_CARRE_GRAND, TAILLE_POLICE, TAILLE_CARRE, MATRICE_HAUT):
    font = pygame.font.Font(None, TAILLE_POLICE)
    for X in range(NBR_CARRE_GRAND):
        for Y in range(NBR_CARRE_PETIT):
            X_START = (X_ORIGINE + X * TAILLE_CARRE + 3) + TAILLE_CARRE//4 + 3
            Y_START = (Y_ORIGINE - NBR_CARRE_PETIT * TAILLE_CARRE + 3) + Y * TAILLE_CARRE + 3 + TAILLE_CARRE//4
