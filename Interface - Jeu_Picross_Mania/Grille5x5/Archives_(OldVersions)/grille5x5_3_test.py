...
# Affichage des différentes grilles
    Affichage_grille(FENETRE, VERT_PIN, CANARD, CANARD, NOIR)
    ...
    pygame.draw.rect(FENETRE, NOIR, (350, 300, TAILLE_CARRE, TAILLE_CARRE), 1)
...
# Cette boucle s'effectue si on est dans le cas d'un clic gauche (1)
                if event.button == 1: # dans le cas d'un clic gauche
                    ...
                    #Coordonnées des cases de la grille centrale
                        ...
                        CASE_Y = (event.pos[1] - MARGE_Y1)//TAILLE_CARRE  # POURQUOI + 1 ??? SANS CA LES COORD SONT PAS BONNES ?!
                        print((CASE_X,CASE_Y))
