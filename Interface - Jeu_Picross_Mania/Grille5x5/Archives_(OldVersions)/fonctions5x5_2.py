...
def Afficher_carre_noir(SUPPORT, COULEUR, ASCISSE_ORIGINE, ORDONNE_ORIGINE, CASE_X, CASE_Y, TAILLE_CARRE):
    pygame.draw.rect(SUPPORT, COULEUR, (ABSCISSE_ORIGINE + CASE_X*TAILLE_CARRE, ORDONNEE_ORIGINE + CASE_Y*TAILLE_CARRE, TAILLE_CARRE, TAILLE_CARRE))

def Afficher_contour_carre():
    pass

def Afficher_croix_noire():
    pass
