...
from fonctions5x5_3_test import *
...
Matrice_grille_gauche1_niveau1 = array([(0, 1, 1), (0, 0, 5), (0, 1, 1), (0, 0, 5), (0, 1, 1)])
...
# Affichage des différentes grilles
    ...
    X_START = X_ORIGINE + 2 * TAILLE_CARRE + 3
    ...
    Y_START = Y_ORIGINE + 1 * TAILLE_CARRE + 3
    ...
    pygame.draw.rect(FENETRE, NOIR, (X_START, Y_START, X_END, Y_END ))
