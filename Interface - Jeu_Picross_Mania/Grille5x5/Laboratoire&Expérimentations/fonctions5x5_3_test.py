...
def Affichage_Grille_Haut_Vertical(SUPPORT,X_START,Y_START, NBR_CARRE_GRAND, NBR_CARRE_PETIT):
    for x in range(NBR_CARRE_GRAND + 1):
        ...
        pygame.draw.line(SUPPORT, CANARD, (X_START, Y_START),(X_END,Y_END), 4)
...
#-------------------------------------------------------------------------------
#                   AFFICHAGE DES INDICATIONS DE GAUCHE
#-------------------------------------------------------------------------------

def Afficher_Indications_Gauche (COULEUR, X_ORIGINE, Y_ORIGINE, MATRICE_GAUCHE):
#On définit la police du texte à écrire et sa taille
