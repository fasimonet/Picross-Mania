...
#BOUCLE D'AFFICHAGE DU MENU PRINCIPAL - Qui s'éxécute tant que la variable "continuer_menu" vaut 1
    while continuer_menu == 1:

#BOUCLE PRINCIPALE - Qui s'exécute dans la BOUCLE D'AFFICHAGE DU MENU PRINCIPALE soit tant que la variable "continuer_menu" vaut 1
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE
...
################################################################################
#BOUCLE DU BOUTTON "PICROSS A RESOUDRE" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTTON "RESOLUTION DE PICROSS" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTTON "CREATION DE PICROSS" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTTON "TUTORIEL" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE D'AFFICHAGE DE LA PAGE "Picross à Résoudre" - Qui s'éxécute tant que la variable "continuer_picross_a_resoudre" vaut 1
...
#BOUCLE DE FERMETURE.1 - Qui s'éxécute dans la BOUCLE PRINCIPALE.1
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE.1
# Si un de ces événements est de type "CLIC" ET que ce clic est un "CLIC GAUCHE"
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
...
#BOUCLE DU BOUTON "RETOUR" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTON "TUTORIEL" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
#Si l'utilisateur clique sur la zone correspondant au bouton "tutoriel"
                if event.pos[0] >= 30 and event.pos[0] <= 30 + LONGUEUR_BOUTON_TUTORIEL and event.pos[1] >= 585 and event.pos[1] <= 585 + HAUTEUR_BOUTON_TUTORIEL:
                    # Fermeture du menu principal
                    continuer_picross_a_resoudre = 0
...
#BOUCLE DU BOUTON "NIVEAU 1" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTON "NIVEAU 2" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTON "NIVEAU 3" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTON "NIVEAU 4" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE DU BOUTON "MON NIVEAU" - Qui s'éxécute dans la BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE"
...
#BOUCLE D'AFFICHAGE DE LA PAGE "Niveau 1" - Qui s'éxécute tant que la variable "continuer_niveau1" vaut 1
...
#BOUCLE DE FERMETURE.2 - Qui s'éxécute dans la BOUCLE PRINCIPALE.2
...
################################################################################
#BOUCLE D'AFFICHAGE DE LA PAGE "Niveau 2" - Qui s'éxécute tant que la variable "continuer_niveau2" vaut 1
...
#BOUCLE DE FERMETURE.3 - Qui s'éxécute dans la BOUCLE PRINCIPALE.3
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE.3
# Si un de ces événements est de type "CLIC" ET que ce clic est un "CLIC GAUCHE"
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
...
################################################################################
#BOUCLE D'AFFICHAGE DE LA PAGE "Niveau 3" - Qui s'éxécute tant que la variable "continuer_niveau3" vaut 1
...
#BOUCLE DE FERMETURE.4 - Qui s'éxécute dans la BOUCLE PRINCIPALE.4
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE.4
# Si un de ces événements est de type "CLIC" ET que ce clic est un "CLIC GAUCHE"
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
...
################################################################################
#BOUCLE D'AFFICHAGE DE LA PAGE "Niveau 4" - Qui s'éxécute tant que la variable "continuer_niveau4" vaut 1
...
#BOUCLE DE FERMETURE.5 - Qui s'éxécute dans la BOUCLE PRINCIPALE.5
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE.5
# Si un de ces événements est de type "CLIC" ET que ce clic est un "CLIC GAUCHE"
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
...
################################################################################
#BOUCLE D'AFFICHAGE DE LA PAGE "Niveau personnalisé" - Qui s'éxécute tant que la variable "continuer_mon_niveau" vaut 1
...
#BOUCLE DE FERMETURE.6 - Qui s'éxécute dans la BOUCLE PRINCIPALE.6
...
#BOUCLE D'EVENEMENT DE TYPE "CLIC GAUCHE" - Qui s'éxécute dans la BOUCLE PRINCIPALE.6
# Si un de ces événements est de type "CLIC" ET que ce clic est un "CLIC GAUCHE"
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
...
################################################################################
#BOUCLE D'AFFICHAGE DE LA PAGE "Tutoriel" - Qui s'éxécute tant que la variable "continuer_tutoriel" vaut 1
...
#BOUCLE DE FERMETURE.7 - Qui s'éxécute dans la BOUCLE PRINCIPALE.7
