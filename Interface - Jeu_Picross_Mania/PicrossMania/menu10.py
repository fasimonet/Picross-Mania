...
#Liste qui regarde si une grille est en cours et laquelle dans le niveau 1
PICROSS_EN_COURS_NIV3 = [False, False, False, False, False, False, False, False, False]

#Liste qui regarde quelles grilles sont complétées dans le niveau 1
PICROSS_COMPLETS_NIV3 = [0, 0, 0, 0, 0, 0, 0, 0, 0]

#Variable qui représente le nombre de picross complétés
SOMME_PICROSS_COMPLETS_NIV3 = 0
...
#Liste qui regarde si une grille est en cours et laquelle dans le niveau 1
PICROSS_EN_COURS_NIV4 = [False, False, False, False, False, False, False, False, False]

#Liste qui regarde quelles grilles sont complétées dans le niveau 1
PICROSS_COMPLETS_NIV4 = [0, 0, 0, 0, 0, 0, 0, 0, 0]

#Variable qui représente le nombre de picross complétés
SOMME_PICROSS_COMPLETS_NIV4 = 0
...
# Collage des différents boutons sur la fenêtre :
        ...
        if pygame.mouse.get_focused():
            #Affichage de l'image représentant une grille vide
            if Rectgrille1.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[0] == 0 :
                    FENETRE.blit(BOUTON_GRILLE1_NIVEAU3, (200, 130))
                elif PICROSS_COMPLETS_NIV3[0] == 1:
                    FENETRE.blit(BOUTON_GRILLE1_NIVEAU3_RESOLUE, (200,130))
            #Affichage de l'image représentant un 2
            elif Rectgrille2.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[1] == 0 :
                    FENETRE.blit(BOUTON_GRILLE2_NIVEAU3, (405, 130))
                elif PICROSS_COMPLETS_NIV3[1] == 1:
                    FENETRE.blit(BOUTON_GRILLE2_NIVEAU3_RESOLUE, (405,130))
            #Affichage de l'image représentant un 3
            elif Rectgrille3.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[2] == 0 :
                    FENETRE.blit(BOUTON_GRILLE3_NIVEAU3, (610, 130))
                elif PICROSS_COMPLETS_NIV3[2] == 1:
                    FENETRE.blit(BOUTON_GRILLE3_NIVEAU3_RESOLUE, (610,130))
            #Affichage de l'image représentant un 4
            elif Rectgrille4.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[3] == 0 :
                    FENETRE.blit(BOUTON_GRILLE4_NIVEAU3, (200, 305))
                elif PICROSS_COMPLETS_NIV3[3] == 1:
                    FENETRE.blit(BOUTON_GRILLE4_NIVEAU3_RESOLUE, (200,305))
            #Affichage de l'image représentant un 5
            elif Rectgrille5.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[4] == 0 :
                    FENETRE.blit(BOUTON_GRILLE5_NIVEAU3, (405, 305))
                elif PICROSS_COMPLETS_NIV3[4] == 1:
                    FENETRE.blit(BOUTON_GRILLE5_NIVEAU3_RESOLUE, (405,305))
            #Affichage de l'image représentant un 6
            elif Rectgrille6.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[5] == 0 :
                    FENETRE.blit(BOUTON_GRILLE6_NIVEAU3, (610, 305))
                elif PICROSS_COMPLETS_NIV3[5] == 1:
                    FENETRE.blit(BOUTON_GRILLE6_NIVEAU3_RESOLUE, (610,305))
            #Affichage de l'image représentant un 7
            elif Rectgrille7.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[6] == 0 :
                    FENETRE.blit(BOUTON_GRILLE7_NIVEAU3, (200, 480))
                elif PICROSS_COMPLETS_NIV3[6] == 1:
                    FENETRE.blit(BOUTON_GRILLE7_NIVEAU3_RESOLUE, (200,480))
            #Affichage de l'image représentant un 8
            elif Rectgrille8.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[7] == 0 :
                    FENETRE.blit(BOUTON_GRILLE8_NIVEAU3, (405, 480))
                elif PICROSS_COMPLETS_NIV3[7] == 1:
                    FENETRE.blit(BOUTON_GRILLE8_NIVEAU3_RESOLUE, (405,480))
            #Affichage de l'image représentant un 9
            elif Rectgrille9.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV3[8] == 0 :
                    FENETRE.blit(BOUTON_GRILLE9_NIVEAU3, (610, 480))
                elif PICROSS_COMPLETS_NIV3[8] == 1:
                    FENETRE.blit(BOUTON_GRILLE9_NIVEAU3_RESOLUE, (610,480))

# On dessine une ligne jaune qui sépare l'entête et la partie basse de l'interface
        pygame.draw.line(FENETRE, ORANGE_NIVEAU3, (310,110), (760,110), 5)

# Affichage de la barre de progression
        if SOMME_PICROSS_COMPLETS_NIV3 == 0 :
            FENETRE.blit(pygame.image.load("barre_progression_0sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 1 :
            FENETRE.blit(pygame.image.load("barre_progression_1sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 2 :
            FENETRE.blit(pygame.image.load("barre_progression_2sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 3 :
            FENETRE.blit(pygame.image.load("barre_progression_3sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 4 :
            FENETRE.blit(pygame.image.load("barre_progression_4sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 5 :
            FENETRE.blit(pygame.image.load("barre_progression_5sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 6 :
            FENETRE.blit(pygame.image.load("barre_progression_6sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 7 :
            FENETRE.blit(pygame.image.load("barre_progression_7sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 8 :
            FENETRE.blit(pygame.image.load("barre_progression_8sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV3 == 9 :
            FENETRE.blit(pygame.image.load("barre_progression_9sur9.PNG"), (310, 80))

# Affichage du texte
        Texte(FENETRE, TITRE_NIVEAU3, 310, 50, NOIR, None, 30)
...
#Si l'utilisateur clique sur la zone correspondant au bouton "tutoriel"
                ...
                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC1
                    MAT_GAUC = MAT_GAUC_NIV3_PIC1
                    MAT_HAUT = MAT_HAUT_NIV3_PIC1
                    PICROSS_EN_COURS_NIV3[0] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC2
                    MAT_GAUC = MAT_GAUC_NIV3_PIC2
                    MAT_HAUT = MAT_HAUT_NIV3_PIC2
                    PICROSS_EN_COURS_NIV3[1] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC3
                    MAT_GAUC = MAT_GAUC_NIV3_PIC3
                    MAT_HAUT = MAT_HAUT_NIV3_PIC3
                    PICROSS_EN_COURS_NIV3[2] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC4
                    MAT_GAUC = MAT_GAUC_NIV3_PIC4
                    MAT_HAUT = MAT_HAUT_NIV3_PIC4
                    PICROSS_EN_COURS_NIV3[3] = True

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC5
                    MAT_GAUC = MAT_GAUC_NIV3_PIC5
                    MAT_HAUT = MAT_HAUT_NIV3_PIC5
                    PICROSS_EN_COURS_NIV3[4] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC6
                    MAT_GAUC = MAT_GAUC_NIV3_PIC6
                    MAT_HAUT = MAT_HAUT_NIV3_PIC6
                    PICROSS_EN_COURS_NIV3[5] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC7
                    MAT_GAUC = MAT_GAUC_NIV3_PIC7
                    MAT_HAUT = MAT_HAUT_NIV3_PIC7
                    PICROSS_EN_COURS_NIV3[6] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC8
                    MAT_GAUC = MAT_GAUC_NIV3_PIC8
                    MAT_HAUT = MAT_HAUT_NIV3_PIC8
                    PICROSS_EN_COURS_NIV3[7] = True
                    print(PICROSS_EN_COURS_NIV3)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau3 = 0
                    continuer_grille10x10 = 1
                    MAT_CENT = MAT_CENT_NIV3_PIC9
                    MAT_GAUC = MAT_GAUC_NIV3_PIC9
                    MAT_HAUT = MAT_HAUT_NIV3_PIC9
                    PICROSS_EN_COURS_NIV3[8] = True
                    print(PICROSS_EN_COURS_NIV3)
...
# Collage des différents boutons sur la fenêtre :
        ...
        if pygame.mouse.get_focused():
            #Affichage de l'image représentant une grille vide
            if Rectgrille1.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[0] == 0 :
                    FENETRE.blit(BOUTON_GRILLE1_NIVEAU4, (200, 130))
                elif PICROSS_COMPLETS_NIV4[0] == 1:
                    FENETRE.blit(BOUTON_GRILLE1_NIVEAU4_RESOLUE, (200,130))
            #Affichage de l'image représentant un 2
            elif Rectgrille2.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[1] == 0 :
                    FENETRE.blit(BOUTON_GRILLE2_NIVEAU4, (405, 130))
                elif PICROSS_COMPLETS_NIV4[1] == 1:
                    FENETRE.blit(BOUTON_GRILLE2_NIVEAU4_RESOLUE, (405,130))
            #Affichage de l'image représentant un 3
            elif Rectgrille3.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[2] == 0 :
                    FENETRE.blit(BOUTON_GRILLE3_NIVEAU4, (610, 130))
                elif PICROSS_COMPLETS_NIV4[2] == 1:
                    FENETRE.blit(BOUTON_GRILLE3_NIVEAU4_RESOLUE, (610,130))
            #Affichage de l'image représentant un 4
            elif Rectgrille4.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[3] == 0 :
                    FENETRE.blit(BOUTON_GRILLE4_NIVEAU4, (200, 305))
                elif PICROSS_COMPLETS_NIV4[3] == 1:
                    FENETRE.blit(BOUTON_GRILLE4_NIVEAU4_RESOLUE, (200,305))
            #Affichage de l'image représentant un 5
            elif Rectgrille5.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[4] == 0 :
                    FENETRE.blit(BOUTON_GRILLE5_NIVEAU4, (405, 305))
                elif PICROSS_COMPLETS_NIV4[4] == 1:
                    FENETRE.blit(BOUTON_GRILLE5_NIVEAU4_RESOLUE, (405,305))
            #Affichage de l'image représentant un 6
            elif Rectgrille6.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[5] == 0 :
                    FENETRE.blit(BOUTON_GRILLE6_NIVEAU4, (610, 305))
                elif PICROSS_COMPLETS_NIV4[5] == 1:
                    FENETRE.blit(BOUTON_GRILLE6_NIVEAU4_RESOLUE, (610,305))
            #Affichage de l'image représentant un 7
            elif Rectgrille7.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[6] == 0 :
                    FENETRE.blit(BOUTON_GRILLE7_NIVEAU4, (200, 480))
                elif PICROSS_COMPLETS_NIV4[6] == 1:
                    FENETRE.blit(BOUTON_GRILLE7_NIVEAU4_RESOLUE, (200,480))
            #Affichage de l'image représentant un 8
            elif Rectgrille8.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[7] == 0 :
                    FENETRE.blit(BOUTON_GRILLE8_NIVEAU4, (405, 480))
                elif PICROSS_COMPLETS_NIV4[7] == 1:
                    FENETRE.blit(BOUTON_GRILLE8_NIVEAU4_RESOLUE, (405,480))
            #Affichage de l'image représentant un 9
            elif Rectgrille9.collidepoint(event.pos):
                if PICROSS_COMPLETS_NIV4[8] == 0 :
                    FENETRE.blit(BOUTON_GRILLE9_NIVEAU4, (610, 480))
                elif PICROSS_COMPLETS_NIV4[8] == 1:
                    FENETRE.blit(BOUTON_GRILLE9_NIVEAU4_RESOLUE, (610,480))

# Affichage de la barre de progression
        if SOMME_PICROSS_COMPLETS_NIV4 == 0 :
            FENETRE.blit(pygame.image.load("barre_progression_0sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 1 :
            FENETRE.blit(pygame.image.load("barre_progression_1sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 2 :
            FENETRE.blit(pygame.image.load("barre_progression_2sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 3 :
            FENETRE.blit(pygame.image.load("barre_progression_3sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 4 :
            FENETRE.blit(pygame.image.load("barre_progression_4sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 5 :
            FENETRE.blit(pygame.image.load("barre_progression_5sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 6 :
            FENETRE.blit(pygame.image.load("barre_progression_6sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 7 :
            FENETRE.blit(pygame.image.load("barre_progression_7sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 8 :
            FENETRE.blit(pygame.image.load("barre_progression_8sur9.PNG"), (310, 80))
        elif SOMME_PICROSS_COMPLETS_NIV4 == 9 :
            FENETRE.blit(pygame.image.load("barre_progression_9sur9.PNG"), (310, 80))
...
# Affichage du texte
        Texte(FENETRE, TITRE_NIVEAU4, 310, 50, NOIR, None, 30)
...
#Si l'utilisateur clique sur la zone correspondant au bouton "tutoriel"
                ...
                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC1
                    MAT_GAUC = MAT_GAUC_NIV4_PIC1
                    MAT_HAUT = MAT_HAUT_NIV4_PIC1
                    PICROSS_EN_COURS_NIV4[0] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC2
                    MAT_GAUC = MAT_GAUC_NIV4_PIC2
                    MAT_HAUT = MAT_HAUT_NIV4_PIC2
                    PICROSS_EN_COURS_NIV4[1] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 130 and event.pos[1] <= 130 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC3
                    MAT_GAUC = MAT_GAUC_NIV4_PIC3
                    MAT_HAUT = MAT_HAUT_NIV4_PIC3
                    PICROSS_EN_COURS_NIV4[2] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC4
                    MAT_GAUC = MAT_GAUC_NIV4_PIC4
                    MAT_HAUT = MAT_HAUT_NIV4_PIC4
                    PICROSS_EN_COURS_NIV4[3] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC5
                    MAT_GAUC = MAT_GAUC_NIV4_PIC5
                    MAT_HAUT = MAT_HAUT_NIV4_PIC5
                    PICROSS_EN_COURS_NIV4[4] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 305 and event.pos[1] <= 305 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC6
                    MAT_GAUC = MAT_GAUC_NIV4_PIC6
                    MAT_HAUT = MAT_HAUT_NIV4_PIC6
                    PICROSS_EN_COURS_NIV4[5] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 200 and event.pos[0] <= 200 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC7
                    MAT_GAUC = MAT_GAUC_NIV4_PIC7
                    MAT_HAUT = MAT_HAUT_NIV4_PIC7
                    PICROSS_EN_COURS_NIV4[6] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 405 and event.pos[0] <= 405 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC8
                    MAT_GAUC = MAT_GAUC_NIV4_PIC8
                    MAT_HAUT = MAT_HAUT_NIV4_PIC8
                    PICROSS_EN_COURS_NIV4[7] = True
                    print(PICROSS_EN_COURS_NIV4)

                if event.pos[0] >= 610 and event.pos[0] <= 610 + DIMENSION_COTE_BOUTONS_NIVEAUX and event.pos[1] >= 480 and event.pos[1] <= 480 + DIMENSION_COTE_BOUTONS_NIVEAUX:
                    continuer_niveau4 = 0
                    continuer_grille15x15 = 1
                    MAT_CENT = MAT_CENT_NIV4_PIC9
                    MAT_GAUC = MAT_GAUC_NIV4_PIC9
                    MAT_HAUT = MAT_HAUT_NIV4_PIC9
                    PICROSS_EN_COURS_NIV4[8] = True
                    print(PICROSS_EN_COURS_NIV4)
...
# Affichage des différentes grilles
        ...
        if allclose(MAT_CENT, MATRICE_GRILLE_5x5):
            FENETRE.blit(BOUTON_VALIDER, (30, 70))
            if event.type == MOUSEBUTTONDOWN:
                if event.pos[0] >= 30 and event.pos[0] <= 30 + LONGUEUR_BOUTON_RETOUR and event.pos[1] >= 70 and event.pos[1] <= 70 + HAUTEUR_BOUTON_RETOUR:
                    continuer_grille5x5 = 0
                    animation_son = 1
                    animation = 1
...
# Réactualisation de la liste de picross complétés
# Remise a zéro de la liste des picross en cours
                for i in range (len(PICROSS_EN_COURS_NIV3)):
                    if PICROSS_EN_COURS_NIV3[i] == True :
                        PICROSS_COMPLETS_NIV3[i] = 1
                        PICROSS_EN_COURS_NIV3[i] = False
                        SOMME_PICROSS_COMPLETS_NIV3 = somme_elements_liste(PICROSS_COMPLETS_NIV3)
                        print(PICROSS_EN_COURS_NIV3)
                        print(PICROSS_COMPLETS_NIV3)
                        print(SOMME_PICROSS_COMPLETS_NIV3)
...
# Ce programme est la clef de notre projet,
# il se sert d'autres programmes et bibliothèques sous-jacent(e)s afin d'oeuvrer
# à la création d'une grille de jeu picross de dimension 15x15.
#===============================================================================
#                            CORPS DU PROGRAMME
#===============================================================================
#BOUCLE D'EXECUTION - Qui s'exécute tant que la variable "continuer" vaut 1
    while continuer_grille15x15 == 1:
#-------------------------------------------------------------------------------
#                              AFFICHAGE DU FOND
#-------------------------------------------------------------------------------
# Affichage d'une couleur de fond
...
# Affichage des différentes grilles
        Affichage_Grille(FENETRE, X_ORIGINE_15x15, Y_ORIGINE_15x15, 15, 15, 8, TAILLE_CARRE_15x15)

        Afficher_Indic_Gauche(FENETRE, BLUE_PEGASUS, X_ORIGINE_15x15, Y_ORIGINE_15x15, 8, 15, 15, TAILLE_CARRE_15x15, MAT_GAUC, DIVISEUR_15x15)

        Afficher_Indic_Haut(FENETRE, BLUE_PEGASUS, X_ORIGINE_15x15, Y_ORIGINE_15x15, 8, 15, 15, TAILLE_CARRE_15x15, MAT_HAUT, DIVISEUR_15x15)

        if allclose(MAT_CENT, MATRICE_GRILLE_15x15):
            FENETRE.blit(BOUTON_VALIDER, (30, 70))
            if event.type == MOUSEBUTTONDOWN:
                if event.pos[0] >= 30 and event.pos[0] <= 30 + LONGUEUR_BOUTON_RETOUR and event.pos[1] >= 70 and event.pos[1] <= 70 + HAUTEUR_BOUTON_RETOUR:
                    continuer_grille15x15 = 0
...
# Réactualisation de la liste de picross complétés
# Remise a zéro de la liste des picross en cours
                for i in range (len(PICROSS_EN_COURS_NIV4)):
                    if PICROSS_EN_COURS_NIV4[i] == True :
                        PICROSS_COMPLETS_NIV4[i] = 1
                        PICROSS_EN_COURS_NIV4[i] = False
                        SOMME_PICROSS_COMPLETS_NIV4 = somme_elements_liste(PICROSS_COMPLETS_NIV4)
                        print(PICROSS_EN_COURS_NIV4)
                        print(PICROSS_COMPLETS_NIV4)
                        print(SOMME_PICROSS_COMPLETS_NIV4)
        else :
                continuer_grille15x15 = 1
#-------------------------------------------------------------------------------
#      AFFICHAGE DES FORMES DANS LES CASES DE LA GRILLE : CARRES ET CROIX
...
#BOUCLE AFFICHAGE_FORMES - Qui s'exécute dans la BOUCLE D'EXECUTION soit tant que la variable "continuer" vaut 1
# Cette boucle parcourt la grille centrale en longueur.
        for x in range(L_15x15):

#BOUCLE AFFICHAGE_FORMES.1 - Qui s'exécute dans la BOUCLE AFFICHAGE_FORMES
# Cette boucle parcourt la grille centrale en hauteur.
            for y in range(H_15x15):

#BOUCLE AFFICHAGE_FORMES.VIDE - Qui s'exécute dans la BOUCLE AFFICHAGE_FORMES.1
# Cette boucle affiche un carré de la couleur de fond lorsque la matrice aux coordonnées [x,y] est égale à 0 càd dans le cas d'une case vide.
                if MATRICE_GRILLE_15x15[x,y]== 0:
                    Afficher_Carre(FENETRE, BLANC_CREME, BLANC_CREME, X_ORIGINE_15x15, Y_ORIGINE_15x15, x, y, TAILLE_CARRE_15x15, 1)

#BOUCLE AFFICHAGE_FORMES.CARRE - Qui s'exécute dans la BOUCLE AFFICHAGE_FORMES.1
# Cette boucle affiche un carré de couleur prédéfinie lorsque la matrice aux coordonnées [x,y] est égale à 1 càd dans le cas d'une case noircie.
                elif MATRICE_GRILLE_15x15[x,y]== 1:
                    Afficher_Carre(FENETRE, VERT_PIN, BLANC_CREME, X_ORIGINE_15x15, Y_ORIGINE_15x15, x, y, TAILLE_CARRE_15x15, 1)

#BOUCLE AFFICHAGE_FORMES.CROIX - Qui s'exécute dans la BOUCLE AFFICHAGE_FORMES.1
# Cette boucle affiche une croix de couleur prédéfinie lorsque la matrice aux coordonnées [x,y] est égale à 2 càd dans le cas d'une case cochée.
                elif MATRICE_GRILLE_15x15[x,y]== 2:
                    Afficher_Croix(FENETRE, VERT_PIN, X_ORIGINE_15x15, Y_ORIGINE_15x15, x, y, TAILLE_CARRE_15x15)
...
#Si l'utilisateur clique sur la zone correspondant au bouton "Retour"
                if event.pos[0] >= 30 and event.pos[0] <= 30+LONGUEUR_BOUTON_RETOUR and event.pos[1] >= 40 and event.pos[1] <= 40+HAUTEUR_BOUTON_RETOUR:
                    # Fermeture de la fenêtre "Niveau 3"
                    continuer_grille15x15 = 0
                    MATRICE_GRILLE_15x15 = zeros((COLONNES_15x15,LIGNES_15x15))
                    # Ouverture du niveau 4
                    continuer_niveau4 = 1

                if event.pos[0] >= X_ORIGINE_15x15 and event.pos[0] <= X_ORIGINE_15x15 + NBR_CARRE_CENTRAL_15x15 * TAILLE_CARRE_15x15 and event.pos[1] >= Y_ORIGINE_15x15 and event.pos[1] <= Y_ORIGINE_15x15 + TAILLE_CARRE_15x15 * NBR_CARRE_CENTRAL_15x15:
                    # Coordonnées des cases de la grille centrale
                    CASE_Y = (event.pos[0] - MARGE_X1_15x15)//TAILLE_CARRE_15x15
                    CASE_X = (event.pos[1] - MARGE_Y1_15x15)//TAILLE_CARRE_15x15
                    print((CASE_X,CASE_Y))
...
#BOUCLE EVENT.CLICGAUCHE.1 - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE
# Cette boucle parcourt la grille centrale en longueur.
                        for Y in range (L_15x15):   #Pour Y allant de 0 au nombre de ligne de la matrice
#BOUCLE EVENT.CLICGAUCHE.2 - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE et dans la BOUCLE EVENT.CLICGAUCHE.1
# Cette boucle parcourt la grille centrale en hauteur.
                            for X in range (H_15x15):       #Pour X allant de 0 à la longueur d’une ligne de la matrice - 1 (= nombre de colonnes -1) = 4
#BOUCLE EVENT.CLICGAUCHE.3 - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE, BOUCLE EVENT.CLICGAUCHE.1 et BOUCLE EVENT.CLICGAUCHE.2.
# Cette boucle s'effectue SI ET SEULEMENT SI les compteurs (X,Y) sont équivalents aux coordonnées des cases (CASE_X,CASE_Y)
                                if X == CASE_X and Y == CASE_Y:
...
#BOUCLE EVENT.CLICGAUCHE.VIDE - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE, BOUCLE EVENT.CLICGAUCHE.1, BOUCLE EVENT.CLICGAUCHE.2, BOUCLE EVENT.CLICGAUCHE.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee [CASE_X;CASE_Y] est vide (0)
                                    if MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 0:
                                        # Assignation d'un 1 dans la matrice pour la coordonnee [CASE_X;CASE_Y] pour indiquer que la case contient un CARRE
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 1

#BOUCLE EVENT.CLICGAUCHE.CARRE - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE, BOUCLE EVENT.CLICGAUCHE.1, BOUCLE EVENT.CLICGAUCHE.2, BOUCLE EVENT.CLICGAUCHE.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee [CASE_X;CASE_Y] comporte un CARRE noire (1)
                                    elif MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 1:
                                        # Assignation de la valeur 0 (Case_Vide) dans la matrice pour la coordonnée [CASE_X;CASE_Y] ayant pour conséquence d'effacer le CARRE
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 0

#BOUCLE EVENT.CLICGAUCHE.CROIX - Qui s'exécute dans la BOUCLE EVENT.CLICGAUCHE, BOUCLE EVENT.CLICGAUCHE.1, BOUCLE EVENT.CLICGAUCHE.2, BOUCLE EVENT.CLICGAUCHE.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee (CASE_X;CASE_Y) comporte une CROIX noire (2)
                                    elif MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 2:
                                        # Assignation d'un 1 dans la matrice pour la coordonnee (case_x;case_y) pour indiquer que la case contient un CARRE
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 1
                                    print(MATRICE_GRILLE_15x15)
...
#BOUCLE EVENT.CLICDROIT.1 - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT
# Cette boucle parcourt la grille centrale en longueur.
                        for Y in range (L_15x15): #Pour X allant de 0 à la longueur d’une ligne de la matrice-1(= nombre de colonnes -1)
#BOUCLE EVENT.CLICDROIT.2 - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT et dans la BOUCLE EVENT.CLICDROIT.1
# Cette boucle parcourt la grille centrale en hauteur.
                            for X in range (H_15x15): #Pour Y allant de 0 au nombre de ligne de la matrice – 1 
#BOUCLE EVENT.CLICDROIT.3 - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT, BOUCLE EVENT.CLICDROIT.1 et BOUCLE EVENT.CLICDROIT.2.
# Cette boucle s'effectue SI ET SEULEMENT SI les compteurs (X,Y) sont équivalents aux coordonnées des cases (CASE_X,CASE_Y)
                                if X == CASE_X and Y == CASE_Y:
...
#BOUCLE EVENT.CLICDROIT.VIDE - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT, BOUCLE EVENT.CLICDROIT.1, BOUCLE EVENT.CLICDROIT.2, BOUCLE EVENT.CLICDROIT.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee [CASE_X;CASE_Y] est vide (0)
                                    if MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 0: # comporte un 1 dans la matrice , c'est a dire si la case est vide
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 2 #on assigne 2 dans la matrice pour la coordonnée [CASE_X;CASE_Y]

#BOUCLE EVENT.CLICDROIT.CARRE - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT, BOUCLE EVENT.CLICDROIT.1, BOUCLE EVENT.CLICDROIT.2, BOUCLE EVENT.CLICDROIT.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee [CASE_X;CASE_Y] comporte un CARRE noir (1)
                                    elif MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 1: # comporte un 1 dans la matrice , c'est a dire si la case est noire
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 2 # on assigne 2 dans la matrice pour la coordonnée [CASE_X;CASE_Y]

#BOUCLE EVENT.CLICDROIT.CROIX - Qui s'exécute dans la BOUCLE EVENT.CLICDROIT, BOUCLE EVENT.CLICDROIT.1, BOUCLE EVENT.CLICDROIT.2, BOUCLE EVENT.CLICDROIT.3.
# Cette boucle s'effectue SI ET SEULEMENT SI la matrice pour la coordonnee (CASE_X;CASE_Y) comporte une CROIX noire (2)
                                    elif MATRICE_GRILLE_15x15[CASE_X, CASE_Y] == 2: #comporte un 2 dans la matrice c'est a dire si la case est cochée
                                        MATRICE_GRILLE_15x15[CASE_X, CASE_Y] = 0 # on assigne 0 dans la matrice pour la coordonnée [CASE_X;CASE_Y]
                                    print(MATRICE_GRILLE_15x15)
